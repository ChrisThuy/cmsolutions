...
(function () {
  ...
  gsap.utils.toArray('.scene').forEach(function (scene) {
    ...
    /*
      ...
      So the copy enters faster (ENTER), holds far longer (HOLD, up from
      ~0.4), and leaves quickly (EXIT). The beat between scenes survives —
      it should, it is a film — but it is a beat now rather than a gap.
    */
    var ENTER = 0.55, HOLD = '+=1.15', EXIT = 0.45;
