...
export function extractBusiness(html, pageUrl) {
  ...
  return {
    ...
    // If the page being read has no country, that is a fact about the page.
    // Filling in "GB" would launder a guess into the user's form.
    country: decode(address.addressCountry),
